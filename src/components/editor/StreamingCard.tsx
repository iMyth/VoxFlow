    ...
    <Card className={`${c.border} ${c.bg}`}>
      <CardContent>
        <div className="flex items-center justify-between mb-2">
          ...
          {!isAnalyzing && <p className={`text-sm font-medium ${c.text}`}>{label}</p>}
          {onCancel && (
        ...
        <pre
          className={`text-sm whitespace-pre-wrap ${c.textLight}`}
          style={{ contain: 'layout style', minHeight: '4rem', maxHeight: '60vh', overflowY: 'auto' }}
        >
          {text}
