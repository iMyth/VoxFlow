...
```html
<audio data-start="0" data-duration="6" data-track-index="2" data-volume="0.5" src="assets/music.wav"></audio>
```
...
```html
<video muted playsinline data-start="0" data-duration="5" data-track-index="0" src="assets/intro.mp4"></video>
```
